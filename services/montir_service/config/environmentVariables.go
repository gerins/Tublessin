...
var DbDriver,
	...
	DbHost,
	DbPort,
	GRPC_SERVICE_MONTIR_HOST,
	GRPC_SERVICE_MONTIR_PORT string

// Config server Host and Port
func SetEnvironmentVariables() {
	GRPC_SERVICE_MONTIR_HOST = os.Getenv("GRPC_SERVICE_MONTIR_HOST")
	GRPC_SERVICE_MONTIR_PORT = os.Getenv("GRPC_SERVICE_MONTIR_PORT")
	...
	log.Println(`GRPC_SERVICE_MONTIR_HOST=`, GRPC_SERVICE_MONTIR_HOST)
	log.Println(`GRPC_SERVICE_MONTIR_PORT=`, GRPC_SERVICE_MONTIR_PORT)
	fmt.Println()
